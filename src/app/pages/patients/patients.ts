...
@Component({
  ...
  imports: [TableModule, CommonModule, ButtonModule, HttpClientModule, FormsModule, IconFieldModule, InputIconModule, InputTextModule],
})
export class Patients {
  ...
  isLastPage(): boolean {
    return this.patients() ? this.first + this.rows >= this.patients().length : true;
  }
